...
- 💰 Registrar gastos.
- 🧾 Indicar quién pagó cada gasto.
- ⚖️ Dividir gastos entre los participantes.
- 📊 Consultar balances individuales y grupales.
- 💸 Saber quién le debe a quién.
- 🔐 Gestionar usuarios y autenticación.
- 📱 Exponer una API REST preparada para diferentes clientes.

> Cuadramos busca mantener las cuentas claras para que la plata no se convierta en un problema entre amigos.
